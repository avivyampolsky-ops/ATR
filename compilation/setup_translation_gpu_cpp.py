...
core_include = str(source_root / "cpp_modules" / "hpp")
if core_include not in opencv_flags["include_dirs"]:
    opencv_flags["include_dirs"].append(core_include)
utils_include = str(source_root / "cpp_utils" / "hpp")
if utils_include not in opencv_flags["include_dirs"]:
    opencv_flags["include_dirs"].append(utils_include)
project_include = str(source_root)
if project_include not in opencv_flags["include_dirs"]:
    opencv_flags["include_dirs"].append(project_include)
...
ext_modules = [
    Pybind11Extension(
        "python_modules._translation_gpu_cpp",
        [str(source_root / "cpp_modules" / "cpp" / "registrator.cpp")],
    ...
    Pybind11Extension(
        "python_modules._detector_cpp",
        [str(source_root / "cpp_modules" / "cpp" / "detector.cpp")],
        include_dirs=opencv_flags["include_dirs"],
        library_dirs=opencv_flags["library_dirs"],
        libraries=opencv_flags["libraries"],
        extra_compile_args=opencv_flags["extra_compile_args"],
    ...
    Pybind11Extension(
        "python_modules._register_detect_cpp",
        [
            str(source_root / "cpp_modules" / "cpp" / "register_detect_pybind.cpp"),
            str(source_root / "cpp_modules" / "cpp" / "kalman.cpp"),
            str(source_root / "cpp_utils" / "cpp" / "cpp_utils.cpp"),
        ],
        include_dirs=opencv_flags["include_dirs"],
        library_dirs=opencv_flags["library_dirs"],
        libraries=opencv_flags["libraries"],
